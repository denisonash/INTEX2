...
namespace Intex2.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult ViewCrashes(int pageNum = 1)
        {
            ...
            //collecting the values for the filters
        ...
        {
            //collecting the info passed into the filter to pass into the View Model to affect Pagination and which values show on the page
            ...
            var x = new CrashesViewModel
            {
                //collecting crashes with only certain parameters
                Crashes = _repo.Crashes
                ...
                PageInfo = new PageInfo
                {
                    //setting a new pagination in place for only the crashes with the filter
